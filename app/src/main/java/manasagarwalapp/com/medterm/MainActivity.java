...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ArrayAdapter<String>(this, R.layout.list_item, R.id.txtitem, getResources().getStringArray(R.array.Glossary));
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                String[] comparing = getResources().getStringArray(R.array.Glossary);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_1:
                Toast.makeText(MainActivity.this, "Transferring you to Abbreviations and Meanings Page", Toast.LENGTH_SHORT).show();
            ...
            case R.id.menu_2:
                Toast.makeText(MainActivity.this, "Transferring you to Glossary", Toast.LENGTH_SHORT).show();
            ...
            case R.id.menu_3:
                Toast.makeText(MainActivity.this, "Transferring you to Prefixes and Roots", Toast.LENGTH_SHORT).show();
            ...
            case R.id.menu_4:
                Toast.makeText(MainActivity.this, "Transferring you to Settings", Toast.LENGTH_SHORT).show();
